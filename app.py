...
from tensorflow.keras.layers import Dense, Dropout, Activation, Lambda, Convolution1D
from tensorflow.keras.layers import Embedding
from tensorflow.keras.layers import LSTM, SimpleRNN, GRU
#from tensorflow.keras.layers.core import Dense, Dropout, Activation, Lambda
...
# loading
with open('token04_Model2.pickle', 'rb') as handle:
    Load_Token = pickle.load(handle)

loaded_model = load_model('LSTM04_Model2.h5')
